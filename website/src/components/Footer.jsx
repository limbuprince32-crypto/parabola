...
const footerLinks = {
  ...
  Legal: ["Privacy", "Terms", "Cookie Policy", "License", "Compliance"],
};
export default function Footer() {
  return (
    <footer className="border-t border-slate-800 bg-slate-950/50 back-drop-blur-sm">
...
/>
            ...
            <p className="text-gray-400 mb-4 sm:mb-6 mx-w-xs mx-auto sm:mx-0 text-sm sm:text-base">
              Technology with purpose. Innovation without limits.
            </p>
                  ...
                  <ul className="space-y-2 sm:space-y-3">
                    {links.map((link) => (
                      <li key={link}>
                        <a
                          href="#"
                          className="text-gray-400 hover:text-white transition-colors duration-200 text-xs sm:text"
                        >
                          {link}
                        </a>
                      </li>
